/*
 * SheetJS Community Edition (xlsx) — MINI build, v0.20.3
 ...
 * Vendored locally because the site CSP (script-src 'self') forbids CDNs.
 * Lazy-loaded by export.js (ensureXlsx) only when the user exports .xlsx.
 * Do not hand-edit — replace by re-downloading a pinned build.
 */
